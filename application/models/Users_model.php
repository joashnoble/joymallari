...
class Users_model extends CORE_Model{
    ...
    function create_default_user(){
        ...
        $sql="INSERT IGNORE INTO user_accounts
              ...
              VALUES
                  (1,'admin',SHA1('admin'),'Administrator','','System','Angeles City','jdevtechsolution@gmail.com','0955-283-3018',1)";
        $this->db->query($sql);

    }

    function authenticate_user($uname,$pword){
        $this->db->select('ua.user_id,ua.user_name,ua.user_group_id,ua.photo_path,ua.user_email,CONCAT_WS(" ",ua.user_fname,ua.user_mname,ua.user_lname) as user_fullname,ur.*,ug.user_group,ua.date_created');
