                                    ...
                                    <div class="list-inline text-right list-unstyled" style="font-size:8pt;line-height: 100%;float: right;">
                                        <div style="border: 1px solid lightgray;padding: 5px; border-radius: .5em;">
                                            <center>
                                                ...
                                                ?>
                                                    <span style="text-transform: uppercase;font-weight: bold;"><?php echo $row->company_title;?></span><br>
                                                    <span><?php echo $row->company_desc;?></span><br>
                                                    <small>PRC Lic. # <?php echo $row->prc_lic; ?></small><br>
                                                    <small>PHIC Accreditation # <?php echo $row->phic_acc; ?></small><br>
                                                    <small>PTR # <?php echo $row->ptr_no; ?></small><br>
                                                    <small>S2 # <?php echo $row->s2_no; ?></small><br>
                                                <?php }}?>
                                            </center>
                                        </div>
                                    </div>
                            ...
                            <div class="card">
                                ...
                                <footer class="m-t-15 p-20">
                                    <div class="list-inline text-right list-unstyled" style="font-size:8pt;line-height: 100%;float: right;margin-top: 0px;">
                                        <div style="border: 1px solid gray;padding: 5px; border-radius: .5em;">
                                            <center>
                                                <?php if(count($company) > 0){
                                                    foreach($company as $row){
                                                ?>
