	<script>
        ...
        *
        ...
        //*patient medical abstract buttons*/
        var edit_medical_abstract='<button class="btn btn-success btn-xs" name="edit_medical_abstract_details"   data-toggle="tooltip" data-placement="left" title="Edit Details" style="margin-left:5px;"><i class="fa fa-pencil-square-o"></i> </button>';
        var delete_medical_abstract='<button class="btn btn-danger btn-xs" name="remove_medical_abstract"  data-toggle="tooltip" data-placement="left" title="Move to trash" style="margin-left:5px;"><i class="fa fa-trash"></i> </button>';

        //*patient nephro order buttons*/
        var edit_nephro_order='<button class="btn btn-success btn-xs" name="edit_nephro_order" data-toggle="tooltip" data-placement="left" title="Edit Details" style="margin-left:5px;"><i class="fa fa-pencil-square-o"></i> </button>';
        var delete_nephro_order='<button class="btn btn-danger btn-xs" name="remove_nephro_order" data-toggle="tooltip" data-placement="left" title="Move to trash" style="margin-left:5px;"><i class="fa fa-trash"></i> </button>';

		/*patient diagnostic buttons*/
        var edit_diagnostic='<button class="btn btn-success btn-xs" name="edit_diagnostic" data-toggle="tooltip" data-placement="left" title="Edit Details" style="margin-left:5px;"><i class="fa fa-pencil-square-o"></i> </button>';
        var remove_diagnostic='<button class="btn btn-danger btn-xs" name="remove_diagnostic"  data-toggle="tooltip" data-placement="left" title="Move to trash" style="margin-left:5px;"><i class="fa fa-trash"></i> </button>';

		/*patient medical cert buttons*/
        ...
        var remove_admitting_order='<button class="btn btn-danger btn-xs" name="remove_info" data-toggle="tooltip" data-placement="left" title="Move to trash" style="margin-left:5px;"><i class="fa fa-trash" aria-hidden="true"></i></button>';        
