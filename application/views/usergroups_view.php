    ...
    <section class="content">
        <div class="box">
            <div class="box-header" style="">
              <button class="btn btn-success right_usergroup_create" id="btn_new"><i class="fa fa-barcode" aria-hidden="true"></i> New User Group</button>
            </div>
            <!-- /.box-header -->
                                    ...
                                    <div class="box-body">
                                      <div class="box-group" id="accordion">
                                        ...
                                        <div class="panel box box-success">
                                          <div class="box-header with-border">
                                            <h4 class="box-title">
                                              <a data-toggle="collapse" data-parent="#accordion" href="#collapseprescription" class="collapsed" aria-expanded="false">
                                                Medical Record : Prescription
                                              </a>
                                            </h4>
                                          </div>
                                          <div id="collapseprescription" class="panel-collapse collapse" aria-expanded="false">
                                            <div class="box-body">
                                              <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="input-group">
                                                            <span class="input-group-addon"><i class="fa fa-cogs" aria-hidden="true"></i></span>
                                                                <select class="form-control" name="right_prescription_view" >
                                               ...
                                               <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="input-group">
                                                            <span class="input-group-addon"><i class="fa fa-cogs" aria-hidden="true"></i></span>
                                                                <select class="form-control" name="right_prescription_create" >
                                                                    <option value="0">Off</option>
                                                                    <option value="1">On</option>
                                                                </select>
                                                        </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="input-group">
                                                            <span class="input-group-addon"><i class="fa fa-cogs" aria-hidden="true"></i></span>
                                                                <select class="form-control" name="right_prescription_edit" >
                                                                    <option value="0">Off</option>
                                                                    <option value="1">On</option>
                                                                </select>
                                                        </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="input-group">
                                                            <span class="input-group-addon"><i class="fa fa-cogs" aria-hidden="true"></i></span>
                                                                <select class="form-control" name="right_prescription_delete" >
                                                                    <option value="0">Off</option>
                                                                    <option value="1">On</option>
                                                                </select>
                                                        </div>
            ...
            "columns": [
                ...
                { targets:[2],data: "user_group_desc" },
                {
                    ...
                    render: function (data, type, full, meta){
                        ...
                        return '<center>'+btn_usergroup_edit+btn_usergroup_trash+'</center>';
                    }
                }
