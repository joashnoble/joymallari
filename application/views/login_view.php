                      ...
                      <div class="login-box-body">
                        ...
                        <p class="login-box-msg" style="font-weight:bold;font-family:Web Serveroff;">Sign in to start your session</p>
                          ...
                          <div class="form-group has-feedback">
                            ...
                            <input type="email" class="form-control" name="user_name" placeholder="Email" autofocus>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6">
                            ...
                            <div class="text-right">
                                ...
                                <h4 class="text-uppercase" style="font-family:tahoma;font-size:9.5pt;">
                                  Pampanga Premier Medical Center
                                </h4>
                      ...
                      <div class="login-box-body">
                        ...
                        <p class="login-box-msg" style="font-weight:bold;font-family:Web Serveroff;">Sign in to start your session</p>
                          ...
                          <div class="form-group has-feedback">
                            ...
                            <input type="email" class="form-control" name="user_name1" placeholder="Email" autofocus>
