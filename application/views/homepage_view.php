      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <h3><?php echo $treatedpatients; ?></h3>
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="box box-solid bg-teal-gradient">
            <div class="box-header">
              ...
              <h3 class="box-title">Patients Graph</h3>
          ...
          <div class="box box-success">
            ...
            <div class="box-body chat wallpostview" id="chat-box">
              <!-- chat item -->
              <?php 
                echo '<script> var wallpost; </script>';
                $count=0;
                foreach($wall_post_list as $wall){

                
                ?>
                  <div class="item">
                    <img src="<?php echo $wall->photo_path; ?>" alt="user image" class="online">

                    <p class="message">
                      <a href="#" class="name">
                        <small class="text-muted pull-right"><i class="fa fa-clock-o"></i> <?php echo $wall->readable; ?></small>
                        <?php echo $wall->fullname; ?>
                      </a>
                ...
                $count++;
                 ...
                 echo '<script> wallpost='.$count.'; </script>';
                ?>
