                    ...
                    if($result->num_rows()>0){//valid username and pword
                        ...
                        $this->session->set_userdata(
                            array(
                                ...
                                'right_nephro_clearance_view'=>$result->row()->right_nephro_clearance_view,
                                'right_nephro_clearance_edit'=>$result->row()->right_nephro_clearance_edit,
                                'right_nephro_clearance_create'=>$result->row()->right_nephro_clearance_create,
                                'right_nephro_clearance_delete'=>$result->row()->right_nephro_clearance_delete,
