    ...
    <section class="content">
        <div class="box">
            <div class="box-header" style="">
              <button class="btn btn-success right_useraccount_create" id="btn_new"><i class="fa fa-barcode" aria-hidden="true"></i> New User</button>
            </div>
            <!-- /.box-header -->
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="col-sm-12">
                                <center>
                                <div class="row" style="border:2px solid #2c3e50;width:50%;margin-top:15px;padding-bottom:10px;">
                                    <h4 style="padding:0px;margin:0px;font-weight:bold;">User Photo</h4>
                                    <hr style="padding:0px;margin:10px;height:2px;background-color:#2c3e50;margin-top:2px;"></hr>
                                        <div id="lightgallery" class="imagelight">
                                            <a name="img_a" href="assets/img/lab.png">
                                                <img Name="img_preview" style="width:150px; height:150px;max-width:100%;" src="assets/img/lab.png" />
                                            </a>
                                        </div>
                                </div>
            ...
            "columns": [
                ...
                { targets:[5],data: "user_group" },
                {
                    ...
                    render: function (data, type, full, meta){
                        return '<center>'+btn_user_edit+btn_user_trash+'</center>';
                    }
                }
