    ...
    <section class="content">
        <div class="box">
            ...
            <div class="box-body table-responsive" >
              <table id="tbl_ref_patient" class="table table-bordered table-striped">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header bgm-indigo">
                        ...
                        <h4 class="modal-title">Patient General Info</h4>
                    </div>
                    ...
                    <div class="modal-footer" >
                        <button id="btn_createrefpatient" style="margin-top:5px;" type="button" class="btn bgm-green">Save
                        </button>
                                ...
                                <div class="col-md-12 container-fluid">
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <div class="fg-line">
                                               <input type="text" name="date_created" placeholder="Date" class="form-control date-picker" data-error-msg="Date is required." required>       
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                        ...
                        <div id="print_medical_abstract_content">
                            <div class="container-fluid">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-6">
                                        <div class="checkbox-left">
                                           ...
                                           <others  class="onemargin" style="margin-left:15px;"> Others Specify :</others><br><input type="text" name="diag_other_specify" id="" style="margin-left:15px;width:70%;border:0px;border-bottom:1px solid black;margin-left:15px;"><br>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-xs-3">
                                        <div class="checkbox-left">
                                           <input class="onemargin" type="checkbox" name="" id="treat_hemo" style="width:50px;border:0px;border-bottom:1px solid black;"> HEMODIALYSIS
                                        </div>
                                    </div>
                                    <div class="col-xs-3">
                                        <div class="checkbox-left">
                                    ...
                                    <div class="col-xs-3">
                                        <div class="checkbox-left">
                                           <input class="onemargin" type="checkbox" name="" id="treat_two_times_a_week" style="width:50px;border:0px;border-bottom:1px solid black;"> two times a week
                                        </div>
                                    </div>
                                    <div class="col-xs-3">
                                        <div class="checkbox-left">
                                ...
                                <div class="row">
                                    <div class="col-xs-2">
                                        <div class="checkbox-left">
                                           <input class="onemargin" type="checkbox" name="" id="med_eryth" style="width:25px;border:0px;border-bottom:1px solid black;"> <tag style="font-size:8pt;">ERYTHROPOIETIN</tag>
                                        </div>
                                    </div>
                                    <div class="col-xs-2">
                                        <div class="checkbox-left">
                                           <input class="onemargin" type="checkbox" name="" id="med_eprex" style="width:25px;border:0px;border-bottom:1px solid black;"> <b style="font-size:9pt;">EPREX</b>
                                        </div>
                                    </div>
                                    <div class="col-xs-2">
                                        <div class="checkbox-left">
                                           <input class="onemargin" type="checkbox" name="" id="med_recormon" style="width:25px;border:0px;border-bottom:1px solid black;"><b> RECORMON </b>
                                        </div>
                                    </div>
                                    <div class="col-xs-2">
                                        <div class="checkbox-left">
                                           <input class="onemargin" type="checkbox" name="" id="med_epotin" style="width:25px;border:0px;border-bottom:1px solid black;"><b> EPOTIN </b>
                                        </div>
                                    </div>
                                    <div class="col-xs-2">
                                        <div class="checkbox-left">
                                           <input class="onemargin" type="checkbox" name="" id="med_eposino" style="width:25px;border:0px;border-bottom:1px solid black;"><b> EPOSINO </b>
                                        </div>
                                    </div>
                                    <div class="col-xs-2">
                                        <div class="checkbox-left">
                                           <input class="onemargin" type="checkbox" name="" id="med_others" style="width:25px;border:0px;border-bottom:1px solid black;"><b> OTHERS </b>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <table style="width:100%;margin:20px;">
                                        ...
                                        <tr>
                                            <td style="width:27.5%;"><input class="onemargin" type="checkbox" name="" id="med_sevelamer" style="width:15px;border:0px;border-bottom:1px solid black;"> <tag style="font-size:7pt;">Sevelamer carbonate 600mg</tag></td>
                                        ...
                                        <tr>
                                            <td style="width:27.5%;"><input class="onemargin" type="checkbox" name="" id="med_calcitriol" style="width:15px;border:0px;border-bottom:1px solid black;"> <tag style="font-size:8pt;">Calcitrol<input type="text" class="mgright" name="" id="" style="width:50px;border:0px;border-bottom:1px solid black;"></tag></td>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width:27.5%;"><input class="onemargin" type="checkbox" name="" id="med_metformin" style="width:15px;border:0px;border-bottom:1px solid black;"> <tag style="font-size:8pt;">Metformin 500mg</tag></td>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width:27.5%;"><input class="onemargin" type="checkbox" name="" id="med_clonidinc" style="width:15px;border:0px;border-bottom:1px solid black;"> <tag style="font-size:8pt;">Clonidinc
                                                <input type="text" class="mgright" name="med_clonidinc_mg" id="" style="width:50px;border:0px;border-bottom:1px solid black;">mg</tag></td>
                                            <td style="width:7.5%;"><input class="margin" type="checkbox" name="" id="med_clonidinc_od" style="width:15px;border:0px;border-bottom:1px solid black;"> <tag style="font-size:7pt;">OD</tag></td>
                                            <td style="width:7.5%;"><input class="margin" type="checkbox" name="" id="med_clonidinc_bid" style="width:15px;border:0px;border-bottom:1px solid black;"> <tag style="font-size:7pt;">BID</tag></td>
                                            <td style="width:7.5%;"><input class="margin" type="checkbox" name="" id="med_clonidinc_tid" style="width:15px;border:0px;border-bottom:1px solid black;"> <tag style="font-size:7pt;">TID</tag></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td style="width:27.5%;"><input class="margin" type="checkbox" name="" id="med_perindopril" style="width:15px;border:0px;border-bottom:1px solid black;"> <tag style="font-size:8pt;">Perindopril<input type="text" class="mgright" name="" id="" style="width:50px;border:0px;border-bottom:1px solid black;">mg</tag></td>
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="text-left">
                                            <p style="font-size:8pt;" clas="ospace">Others: <input type="text" id="medarea" rows="3" name="med_others_med" class="ospace" style="width:100%;border:0px;border-bottom:1px solid black;"><br> <p class="ospace" style="font-size:8pt;"><br>Indicate how many medications checked:</p> <input type="text" name="med_medications_no" style="width:100px;border:0px;border-bottom:1px solid black;text-align:center;"></p>
                                         </div>
                                         <div class="text-left">
                                            <p style="font-size:8pt;">Recommendations<br><input type="text" id="recomarea" rows="3" name="med_recommendations" style="width:100%;border:0px;border-bottom:1px solid black;"></p>
                                         </div>
                                    </div>
                                </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header" style="background-color:#2980b9;" class="table table-striped">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true" class="xbutton">×</span></button>
                        <h4 class="modal-title"> Nephro Record Of : <areafullname class="areafullname"></areafullname></h4>
                    </div>
                    <div class="modal-body">
                        <div class="table table-responsive" style="height: 400px;overflow-x:hidden;overflow-y:scroll;">
                    ...
                    <div class="modal-footer">
                        <button class="btn btn-success right_patientinfo_create" id="btn_new"><i class="fa fa-plus-circle" aria-hidden="true"></i> New Nephro Record</button>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header bgm-green">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true" class="xbutton">×</span></button>
                            <h4 class="modal-title">Create New Nephro Record</h4>
                        </div>
                        <div class="modal-body">
                            <div role="tabpanel" class="container-fluid">
                                <form id="frm_nephro_record" role="form">
                                    <div  id="printcontentpatientdetails">
                                        <titlenephro style="color:#2c3e50;padding:0px;margin:0px;font-size:15pt;font-weight:bold;" class="text-left">Nephro Record</titlenephro><date style="float:right;">Date : <input class="date-picker" name="nephrorecorddate"></date>
                            ...
                            <br>
                        <div class="modal-footer">
                            <button id="printpatientdetails" type="button" class="btn bgm-green waves-effect">Print</button>
        ...
        if(_isChecked==true){
            getmedicalcertificate().done(function(response){
                                if(response.data.length==0){
                                    ...
                                    $('#medical_diagnostics').val('');
                                    $('#medical_diagnostics').val(response.data[0].medical_diagnostics);
                                }
                            }).always(function(){
                                $.unblockUI();
                            });
