      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="hidden-xs right_medlab_view patient_laboratory">
            <a href="javascript:void();" data-toggle="tooltip" data-placement="bottom" title="Laboratory"><i class="fa fa-stethoscope"></i></a>
          </li>
          ...
          <li class="hidden-xs right_labreport_view patient_laboratory_report">
            <a href="javascript:void();" data-toggle="tooltip" data-placement="bottom" title="Laboratory Report"><i class="fa fa-commenting-o"></i></a>
          </li>
